      ...
      <div className={`${isMobile ? (showSidebar ? 'w-full absolute inset-0' : 'hidden') : 'w-64 border-r'} bg-sdl-surface/80 backdrop-blur-3xl border-os-outline/10 flex flex-col z-20 transition-all`}>
        ...
        <div className="p-4 mx-4 mb-6 mt-auto bg-os-surfaceContainerHigh/40 backdrop-blur-xl rounded-2xl border border-os-outline/10 relative overflow-hidden">
           ...
           <div className="flex items-center space-x-2">
             ...
             <Sparkles size={14} className="text-os-secondary" />
           </div>
           <div className="mt-3 h-1 w-full bg-os-surfaceContainerHighest rounded-full overflow-hidden">
             <div className="h-full bg-gradient-to-r from-os-secondary to-os-primary w-[75%] shadow-[0_0_10px_var(--sdl-glow)]" />
           </div>
        </div>
      </div>
        ...
        {activeTab === 'home' || activeTab === 'all' ? (
          <>
            ...
            <div className="mb-8 md:mb-12">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-os-primary/25 via-sdl-surface2 to-sdl-plane transition-transform duration-700 group-hover:scale-105" />
                <div className="absolute inset-0 p-6 md:p-10 flex flex-col justify-end bg-gradient-to-t from-sdl-plane via-sdl-plane/50 to-transparent">
                  <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                    <div>
                      <h1 className="font-display text-3xl md:text-5xl font-black text-sdl-ink mb-1 md:mb-2 drop-shadow-lg group-hover:text-os-primary transition-colors">Snake Retro</h1>
                    ...
                    {/* Decorative twin of the card itself — the whole tile is already the button, so this
                        must stay out of the tab order rather than become a second stop to the same action. */}
            ...
            <div>
              <div className="flex items-center justify-between mb-6">
                ...
                <button className="text-xs md:text-sm font-bold text-os-onSurfaceVariant hover:text-sdl-ink flex items-center space-x-1 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sdl-ink/70 rounded-lg px-1">
                  <span>See All</span>
                  <ChevronRight size={16} className="group-hover:translate-x-1 transition-transform" />
                </button>
              </div>

              {/* All five tiles share one accent grammar. They used to carry a private five-hex palette
                  (#00d2fd/#ff86c3/#9effc8/...) that ignored the colorway entirely, so a mint or pink
                  card sat on a Cocoa or Emerald plane looking like a rendering fault. */}
              <div className="flex space-x-4 md:space-x-6 overflow-x-auto pb-6 scrollbar-hide">
                {/* Retro Arcade */}
                <div {...tileProps('retroarcade', 'Retro Arcade')} className="min-w-[260px] md:min-w-[300px] h-40 md:h-48 rounded-3xl bg-gradient-to-br from-os-primary/20 to-os-secondary/20 border border-os-primary/30 hover:border-os-primary/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sdl-ink/70 transition-all p-5 md:p-6 relative overflow-hidden cursor-pointer group shadow-xl flex flex-col justify-between">
                  ...
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-os-primary/20 flex items-center justify-center border border-os-primary/30 shadow-[0_0_15px_rgb(var(--sdl-accent-rgb)/0.3)]">
                ...
                {/* Memory Match */}
                <div {...tileProps('memory', 'Memory Match')} className="min-w-[260px] md:min-w-[300px] h-40 md:h-48 rounded-3xl bg-gradient-to-br from-os-primary/20 to-os-secondary/20 border border-os-primary/30 hover:border-os-primary/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sdl-ink/70 transition-all p-5 md:p-6 relative overflow-hidden cursor-pointer group shadow-xl flex flex-col justify-between">
                  <div className="absolute -right-10 -top-10 w-32 h-32 bg-os-primary/20 blur-2xl rounded-full group-hover:bg-os-primary/40 transition-all" />
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-os-primary/20 flex items-center justify-center border border-os-primary/30 shadow-[0_0_15px_rgb(var(--sdl-accent-rgb)/0.3)]">
                    <MousePointer2 size={isMobile ? 20 : 24} className="text-os-primary" />
                  </div>
                  <div className="relative z-10">
                    <h3 className="font-display font-bold text-lg md:text-xl mb-1 text-sdl-ink group-hover:text-os-primary transition-colors">Memory Match</h3>
                    <p className="text-xs md:text-sm text-sdl-sec font-medium">Test your visual recall.</p>
                  </div>
                </div>

                {/* Trivia Quest */}
                <div {...tileProps('trivia', 'Trivia Quest')} className="min-w-[260px] md:min-w-[300px] h-40 md:h-48 rounded-3xl bg-gradient-to-br from-os-primary/20 to-os-secondary/20 border border-os-primary/30 hover:border-os-primary/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sdl-ink/70 transition-all p-5 md:p-6 relative overflow-hidden cursor-pointer group shadow-xl flex flex-col justify-between">
                  <div className="absolute -right-10 -top-10 w-32 h-32 bg-os-primary/20 blur-2xl rounded-full group-hover:bg-os-primary/40 transition-all" />
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-os-primary/20 flex items-center justify-center border border-os-primary/30 shadow-[0_0_15px_rgb(var(--sdl-accent-rgb)/0.3)]">
                    <Brain size={isMobile ? 20 : 24} className="text-os-primary" />
                  </div>
                  <div className="relative z-10">
                    <h3 className="font-display font-bold text-lg md:text-xl mb-1 text-sdl-ink group-hover:text-os-primary transition-colors">Trivia Quest</h3>
                    <p className="text-xs md:text-sm text-sdl-sec font-medium">Daily knowledge challenges.</p>
                  </div>
                </div>

                {/* 2048 */}
                <div {...tileProps('2048', '2048 Retro')} className="min-w-[260px] md:min-w-[300px] h-40 md:h-48 rounded-3xl bg-gradient-to-br from-os-primary/20 to-os-secondary/20 border border-os-primary/30 hover:border-os-primary/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sdl-ink/70 transition-all p-5 md:p-6 relative overflow-hidden cursor-pointer group shadow-xl flex flex-col justify-between">
                  <div className="absolute -right-10 -top-10 w-32 h-32 bg-os-primary/20 blur-2xl rounded-full group-hover:bg-os-primary/40 transition-all" />
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-os-primary/20 flex items-center justify-center border border-os-primary/30 shadow-[0_0_15px_rgb(var(--sdl-accent-rgb)/0.3)]">
                    <LayoutGrid size={isMobile ? 20 : 24} className="text-os-primary" />
                  </div>
                  <div className="relative z-10">
                    <h3 className="font-display font-bold text-lg md:text-xl mb-1 text-sdl-ink group-hover:text-os-primary transition-colors">2048 Retro</h3>
                    <p className="text-xs md:text-sm text-sdl-sec font-medium">Merge tiles to reach 2048.</p>
                  </div>
                </div>

                {/* Sudoku */}
                <div {...tileProps('sudoku', 'Sudoku Master')} className="min-w-[260px] md:min-w-[300px] h-40 md:h-48 rounded-3xl bg-gradient-to-br from-os-primary/20 to-os-secondary/20 border border-os-primary/30 hover:border-os-primary/60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sdl-ink/70 transition-all p-5 md:p-6 relative overflow-hidden cursor-pointer group shadow-xl flex flex-col justify-between">
                  <div className="absolute -right-10 -top-10 w-32 h-32 bg-os-primary/20 blur-2xl rounded-full group-hover:bg-os-primary/40 transition-all" />
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-os-primary/20 flex items-center justify-center border border-os-primary/30 shadow-[0_0_15px_rgb(var(--sdl-accent-rgb)/0.3)]">
                    <Hash size={isMobile ? 20 : 24} className="text-os-primary" />
                  </div>
                  <div className="relative z-10">
                    <h3 className="font-display font-bold text-lg md:text-xl mb-1 text-sdl-ink group-hover:text-os-primary transition-colors">Sudoku Master</h3>
                    <p className="text-xs md:text-sm text-sdl-sec font-medium">Train your logical thinking.</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
             ...
             {/* Each row used to carry its own accent hex fed straight into inline styles. Progress is
                 accent; a finished one goes neutral-done, per the rule that "complete" is a settled
                 state, not a second competing colour next to alert. */}
             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {[
                  { title: 'Snake Charmer', desc: 'Reach a length of 50 in Snake Retro.', progress: 80, icon: Gamepad2 },
                  { title: 'Grandmaster', desc: 'Solve a Sudoku puzzle in under 5 minutes.', progress: 100, icon: Hash, completed: true },
                  { title: 'Merge King', desc: 'Reach the 4096 tile in 2048.', progress: 35, icon: LayoutGrid },
                  { title: 'Quick Witt', desc: 'Answer 10 trivia questions correctly in a row.', progress: 60, icon: Brain },
                ].map((ach, i) => (
                  <div key={i} className={`p-6 rounded-3xl bg-sdl-surface relative overflow-hidden group border ${ach.completed ? 'border-sdl-accent/40' : 'border-os-outline/10'}`}>
                    <div className="flex items-center space-x-4 mb-4">
                      {/* NOT `sdl-done`. That role is a neutral grey — law 10 is about status in a
                          data context, where green-beside-red is the anti-pattern. An earned badge
                          is the opposite case: greying completion made the finished row the dullest
                          on the panel, weaker than the three unfinished ones, so it read as
                          disabled. Completion keeps the accent and is marked by weight instead. */}
                      <div className={`w-12 h-12 rounded-2xl flex items-center justify-center border ${ach.completed ? 'border-sdl-accent/30 bg-sdl-accent/20' : 'border-hairline/5 bg-sdl-soft'}`}>
                        <ach.icon size={24} className="text-sdl-accent" />
                      </div>
                      <div>
                        <h3 className="font-bold text-lg flex items-center gap-2">
                          {ach.title}
                          {ach.completed && <Sparkles size={16} className="text-sdl-accent" />}
                        </h3>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="h-2 w-full bg-sdl-sunken rounded-full overflow-hidden">
                        <motion.div
                          initial={{ width: 0 }}
                          animate={{ width: `${ach.progress}%` }}
                          transition={{ duration: 1, delay: i * 0.1 }}
                          className="h-full rounded-full bg-sdl-accent shadow-[0_0_10px_var(--sdl-glow)]"
                        />
                      </div>
                    </div>
                  </div>
          ...
          <div className="h-[60vh] flex flex-col items-center justify-center text-center p-8">
             ...
             <button className="mt-8 px-8 py-3 bg-os-surfaceContainerLow border border-os-outline/10 rounded-2xl font-bold hover:bg-os-surfaceContainerHigh transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sdl-ink/70">
                System Config
             </button>
          </div>
        )}
