      ...
      >
        <div className="flex items-center bg-black/20 rounded-2xl p-1 gap-1 border border-white/5 md:mr-4">
          <button
            ...
            title="App Launcher"
            className={`p-2.5 rounded-xl transition-all cursor-pointer group relative focus-visible:ring-2 focus-visible:ring-os-primary focus-visible:outline-none ${isAppLauncherOpen ? 'bg-os-primary/10 border border-os-primary/30' : 'hover:bg-os-surfaceContainerLow/50 border border-transparent'}`}
          >
          ...
          {!isMobile && (
            <button
              ...
              aria-label="About Me"
              title="About Me"
              className={`p-2.5 rounded-xl transition-all cursor-pointer group relative focus-visible:ring-2 focus-visible:ring-os-secondary focus-visible:outline-none ${openWindows.includes('about') ? 'bg-os-secondary/10 border border-os-secondary/30' : 'hover:bg-os-surfaceContainerLow/50 border border-transparent'}`}
            >
          ...
          <button
            ...
            className={`p-2.5 rounded-xl transition-all cursor-pointer group relative focus-visible:ring-2 focus-visible:ring-os-tertiary focus-visible:outline-none ${isControlCenterOpen ? 'bg-os-tertiary/10 border border-os-tertiary/30' : 'hover:bg-os-surfaceContainerLow/50 border border-transparent'}`}
          >
            {isControlCenterOpen ? (
          ...
          {dockApps.map((app) => {
            ...
            return (
              <button
                ...
                className={`relative p-2.5 transition-all duration-300 cursor-pointer group flex items-center justify-center rounded-2xl focus-visible:ring-2 focus-visible:ring-os-primary focus-visible:outline-none ${isActive ? 'bg-white/10 shadow-[inset_0_0_12px_rgba(255,255,255,0.05)]' : 'hover:bg-os-surfaceContainerLow/50'}`}
              >
                    ...
                    <div className="grid grid-cols-4 gap-3">
                      {featuredApps.map((app) => (
                        <button
                          ...
                          className="flex flex-col items-center justify-center p-2 rounded-2xl hover:bg-white/5 active:bg-white/10 transition-all cursor-pointer group focus-visible:ring-2 focus-visible:ring-os-primary focus-visible:outline-none"
                        >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="ml-auto flex items-center gap-1">
                      <button
                        ...
                        aria-label="Settings"
                        title="Settings"
                        className="p-2 hover:bg-white/10 rounded-xl transition-all cursor-pointer focus-visible:ring-2 focus-visible:ring-os-primary focus-visible:outline-none"
                      ...
                      <button
                        ...
                        aria-label="Logout"
                        title="Logout"
                        className="p-2 hover:bg-red-500/20 rounded-xl transition-all cursor-pointer group/logout focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:outline-none"
