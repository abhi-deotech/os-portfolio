          ...
          {dockApps.map((app) => {
            ...
            return (
              <button
                ...
                className={`relative p-2.5 transition-all duration-300 cursor-pointer group flex items-center justify-center rounded-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30 focus-visible:bg-white/10 ${isActive ? 'bg-white/10 shadow-[inset_0_0_12px_rgba(255,255,255,0.05)]' : 'hover:bg-os-surfaceContainerLow/50'}`}
              >
                    ...
                    <div className={`grid grid-cols-4 gap-3 overflow-y-auto pr-1 flex-grow pb-2 scrollbar-hide`}>
                      {otherApps.map((app) => (
                        <button
                          ...
                          title={`Open ${app.title}`}
                          onClick={() => { openWindow(app.id); toggleAppLauncher(); playSound('click'); }}
                          className="flex flex-col items-center justify-center p-2 rounded-2xl hover:bg-white/5 active:bg-white/10 transition-all cursor-pointer group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-os-primary/30 focus-visible:bg-white/5"
                        >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="ml-auto flex items-center gap-1">
                        <button
                          ...
                          aria-label="Settings"
                          title="Settings"
                          className="p-2 hover:bg-white/10 rounded-xl transition-all cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/30"
