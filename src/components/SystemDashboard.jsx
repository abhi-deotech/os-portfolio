      ...
      <div className="px-6 py-4 flex gap-4 border-b border-hairline/5 bg-black/20">
         <div className="flex-1 flex items-center gap-3">
            ...
            <div className="flex flex-col flex-1">
               <div className="flex justify-between text-[8px] font-black uppercase tracking-widest text-sdl-sec">
                  <span>CPU</span>
                  <span className="text-os-secondary">{metrics.cpu}%</span>
               </div>
               <div className="h-1 bg-veil/5 rounded-full mt-1 overflow-hidden">
                  <motion.div className="h-full bg-os-secondary" animate={{ width: `${metrics.cpu}%` }} />
               </div>
            </div>
         </div>
         <div className="w-px h-8 bg-veil/5" />
         <div className="flex-1 flex items-center gap-3">
            ...
            {activeTab === 'system' && (
              ...
              >
                <div className="space-y-4">
                   <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-sdl-sec px-1">Security Status</h4>
                   <div className="p-4 rounded-2xl bg-os-primary/10 border border-os-primary/20 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                         ...
                         <span className="text-xs font-bold text-sdl-ink">Neural Firewall Active</span>
                      </div>
                ...
                <div className="space-y-4">
                   <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-sdl-sec px-1">Resource Distribution</h4>
                   <div className="grid grid-cols-2 gap-3">
                      <div className="p-4 rounded-2xl bg-veil/[0.03] border border-hairline/5 space-y-2">
                         <span className="text-[9px] font-bold text-sdl-sec uppercase tracking-widest">Uptime</span>
                         <p className="text-sm font-black text-sdl-ink">124:12:05</p>
                      </div>
                      <div className="p-4 rounded-2xl bg-veil/[0.03] border border-hairline/5 space-y-2">
                         <span className="text-[9px] font-bold text-sdl-sec uppercase tracking-widest">Efficiency</span>
