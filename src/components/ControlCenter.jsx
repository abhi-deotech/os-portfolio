...
import { Wifi, Bluetooth, Sun, Volume2, BatteryFull, Signal, Play, SkipForward, Settings2 } from 'lucide-react';
      ...
      {isControlCenterOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-24 left-8 w-[380px] bg-[#0e0e0e]/60 backdrop-blur-3xl border border-white/10 rounded-[2.5rem] p-5 z-[70] shadow-[0_32px_64px_rgba(0,0,0,0.6)] flex flex-col space-y-4 select-none grayscale-0 overflow-hidden"
          >
            ...
            {/* Sliders Container */}
            <div className="bg-[#131313]/60 p-5 rounded-[2rem] border border-os-outline/10 space-y-6">
                <div className="space-y-3">
                   ...
                   <div className="h-6 bg-os-surfaceContainerHighest/50 rounded-full relative overflow-hidden cursor-pointer shadow-inner" onClick={(e) => {
            ...
            <div className="bg-[#131313]/60 p-4 rounded-[2rem] border border-os-outline/10 flex items-center gap-4 relative overflow-hidden group">
                <div className="absolute top-0 right-0 w-[100px] h-[100px] bg-[#cc97ff]/10 blur-[30px] rounded-full pointer-events-none group-hover:bg-[#cc97ff]/20 transition-colors" />
                                <div className="w-14 h-14 bg-gradient-to-br from-[#cc97ff] to-[#00d2fd] rounded-2xl flex items-center justify-center shadow-lg transform group-hover:scale-105 transition-transform duration-300 relative">
                    <div className="absolute inset-0 bg-black/20 rounded-2xl" />
                    <CustomIcon icon={Play} size={20} color="text-white" glow="rgba(255,255,255,0.4)" className="relative z-10" />
                 </div>
                
                <div className="flex-grow z-10">
                   <h4 className="text-xs font-black text-white truncate">Midnight City</h4>
                   <p className="text-[10px] font-bold text-[#cc97ff] truncate uppercase tracking-wider mt-0.5">M83</p>
                </div>
