      ...
      >
        <div className="flex space-x-2.5 z-50 w-24 group/controls" onPointerDown={(e) => e.stopPropagation()}>
          <button 
            ...
            className={`${isMobile ? 'w-5 h-5' : 'w-3.5 h-3.5'} rounded-full bg-[#ff5f56] hover:brightness-110 flex items-center justify-center relative z-50 cursor-pointer border border-[#e0443e] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50`}
          >
          ...
          {!isMobile && (
            <>
              <button
                ...
                className="w-3.5 h-3.5 rounded-full bg-[#ffbd2e] hover:brightness-110 flex items-center justify-center relative z-50 cursor-pointer border border-[#dea123] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
              >
              ...
              <button
                ...
                className="w-3.5 h-3.5 rounded-full bg-[#27c93f] hover:brightness-110 flex items-center justify-center relative z-50 cursor-pointer border border-[#1aab29] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
              >
                {isMaximized ? (
