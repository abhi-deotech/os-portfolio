    ...
    <>
      ...
      >
        <div className="flex space-x-2.5 z-50 w-24 group/controls" onPointerDown={(e) => e.stopPropagation()}>
          <button 
            type="button"
            onClick={() => { closeWindow(id); playSound('click'); }}
            aria-label={`Close ${title}`}
            title="Close"
            className={`${isMobile ? 'w-5 h-5' : 'w-3.5 h-3.5'} rounded-full bg-[#ff5f56] hover:brightness-110 flex items-center justify-center relative z-50 transition-all border border-[#e0443e] focus-visible:ring-2 focus-visible:ring-[#ff5f56] focus-visible:outline-none`}
          >
          ...
          {!isMobile && (
            <>
              <button
                ...
                title="Minimize"
                className="w-3.5 h-3.5 rounded-full bg-[#ffbd2e] hover:brightness-110 flex items-center justify-center relative z-50 transition-all border border-[#dea123] focus-visible:ring-2 focus-visible:ring-[#ffbd2e] focus-visible:outline-none"
              >
              ...
              <button
                ...
                className="w-3.5 h-3.5 rounded-full bg-[#27c93f] hover:brightness-110 flex items-center justify-center relative z-50 transition-all border border-[#1aab29] focus-visible:ring-2 focus-visible:ring-[#27c93f] focus-visible:outline-none"
              >
                {isMaximized ? (
