...
const TaskManager = () => {
  ...
  return (
    <div className="flex flex-col h-full bg-[#050505] text-sdl-ink font-sans overflow-hidden">
      {/* Header */}
      ...
      <div className="flex-grow overflow-auto scrollbar-os">
        <table className="w-full text-left border-collapse">
          <thead className="sticky top-0 bg-[#050505] z-10 border-b border-hairline/5">
          ...
          <tbody>
              ...
              <tr key={p.id} className="border-b border-hairline/[0.02] bg-veil/[0.01]">
                <td className="px-8 py-4">
                  <div className="flex items-center gap-4">
                    <div className={`p-2 rounded-xl bg-veil/5 ${p.color}`}>
                      <p.icon size={16} />
                    </div>
                ...
                <td className="px-8 py-4 text-right">
                  <button 
                    ...
                    className="text-[9px] font-black text-sdl-sec hover:text-red-500 uppercase tracking-widest transition-colors"
                  >
                    KILL
                  </button>
                </td>
            ...
            <AnimatePresence mode="popLayout">
              {openWindows.map((appId) => {
                const meta = appMeta[appId] || { name: appId, icon: Activity, color: 'text-sdl-ink' };
                ...
                return (
                  ...
                  >
                    <td className="px-8 py-5">
                      <div className="flex items-center gap-4">
                        <div className={`p-2 rounded-xl bg-veil/5 ${meta.color}`}>
                          <meta.icon size={18} />
                        </div>
                        <div className="flex flex-col">
                           <span className="text-sm font-bold text-sdl-ink/80">{meta.name}</span>
                    ...
                    <td className="px-8 py-5 text-right">
                      <button
                        ...
                        className="p-2 rounded-lg bg-red-500/10 text-red-500 opacity-0 group-hover:opacity-100 transition-all hover:bg-red-500 hover:text-sdl-onAccent"
                      >
                        <X size={14} />
                      </button>
                    </td>
      ...
      <div className="px-8 py-4 bg-black/40 border-t border-hairline/5 flex justify-between items-center">
         <div className="flex gap-6">
